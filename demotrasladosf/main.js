/* =====================================================
   TRASLADO SIN FRONTERAS — main.js v=20260521
   IIFE — sin ES modules
===================================================== */
(function () {
  'use strict';
  ...
  function safe(fn, name) {
    try { fn(); } catch (e) { console.warn('TSF[' + name + ']', e); }
  }
  ...
  safe(function () {
    ...
    window.__TSF__.closeMob = window.closeMob = closeMob;
  }, 'mobile');
  ...
  safe(function () {
    document.querySelectorAll('a[href^="#"]').forEach(function (a) {
      a.addEventListener('click', function (e) {
        ...
        if (!target) return;
        e.preventDefault();
        if (window.__TSF__.closeMob) window.__TSF__.closeMob();
        window.scrollTo({
  ...
  safe(function () {
    ...
    /* WA / IG floating buttons */
    document.querySelectorAll('a[href*="wa.me"], .float-wa, .float-ig').forEach(function (el) {
    ...
    /* Cards */
    document.querySelectorAll('.servicio-card, .destino-card, .galeria-item, .porque-item, .faq-item').forEach(function (el) {
    ...
    document.querySelectorAll('a:not([href*="wa.me"]):not(.float-wa):not(.float-ig), button, .faq-q').forEach(function (el) {
