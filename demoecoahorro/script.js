...
const fuObs = new IntersectionObserver(entries => {
  entries.forEach(entry => {
    ...
    const parent = entry.target.closest(
      '.ben-grid, .mod-grid, .aceites-grid, .apl-grid, .gal-grid, ' +
      '.faq-list, .proc-steps, .mp-cards, .ps-grid, .cta-final-inner'
    );
    const delay = parent
