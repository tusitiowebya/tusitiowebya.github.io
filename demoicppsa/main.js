/* ==============================================
   I.C.P.P.S.A — main.js v=20260521
   IIFE — sin ES modules
============================================== */
(function () {
  'use strict';
  ...
  function safe(fn, name) {
    try { fn(); } catch (e) { console.warn('ICPPSA[' + name + ']', e); }
  }
  ...
  safe(function () {
    ...
    window.__ICPPSA__.closeMob = window.closeMob = closeMob;
  }, 'mobile');
  ...
  safe(function () {
    document.querySelectorAll('a[href^="#"]').forEach(function (a) {
      a.addEventListener('click', function (e) {
        ...
        if (!target) return;
        e.preventDefault();
        if (window.__ICPPSA__.closeMob) window.__ICPPSA__.closeMob();
        window.scrollTo({
  ...
  safe(function () {
    ...
    /* Cards */
    document.querySelectorAll('.curso-card, .porque-item, .area-block, .valor-card, .gal-item, .meto-step, .faq-item').forEach(function (el) {
