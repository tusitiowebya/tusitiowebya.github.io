/* =====================================================
   TESTA FREDDA — main.js v=20260522
   IIFE — sin ES modules
===================================================== */
(function () {
  'use strict';
  ...
  function safe(fn, name) {
    try { fn(); } catch (e) { console.warn('TF[' + name + ']', e); }
  }
  ...
  safe(function () {
    ...
    window.__TF__.closeMob = window.closeMob = closeMob;
  }, 'mobile');
  ...
  safe(function () {
    document.querySelectorAll('a[href^="#"]').forEach(function (a) {
      a.addEventListener('click', function (e) {
        ...
        if (!target) return;
        e.preventDefault();
        if (window.__TF__.closeMob) window.__TF__.closeMob();
        window.scrollTo({
  ...
  safe(function () {
    ...
    document.querySelectorAll('.prod-card, .cat-cat-card, .ben-item, .gal-item, .faq-item').forEach(function (el) {
    ...
    document.querySelectorAll('a:not([href*="wa.me"]):not(.float-wa):not(.float-ig), button, .faq-q, .filter-btn').forEach(function (el) {
