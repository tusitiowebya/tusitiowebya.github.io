...
export function Hero() {
  return (
    <section id="inicio" className="relative min-h-screen flex items-end">
      ...
      <Image
        src="/images/hero.jpg"
        alt="Vista de Hosteria Nirvana en Villa Gesell"
        fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-6 pb-20 pt-40 md:pb-28">
        <p className="mb-3 text-sm uppercase tracking-[0.25em] text-primary-foreground/70">
          Villa Gesell &middot; Zona Sur
        </p>
        ...
        <p className="mt-6 max-w-lg text-base leading-relaxed text-primary-foreground/80 md:text-lg">
          A 150 metros de la playa del muelle de los pescadores.
          Naturaleza, confort y la serenidad que buscas.
        </p>
        <div className="mt-8 flex flex-wrap gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-primary-foreground px-6 py-3 text-sm font-semibold text-foreground transition-transform hover:scale-105"
          >
            <WhatsAppIcon />
